  ...
  <tr>
    <td height="220" valign="bottom"><p>&nbsp;</p>
      ...
      <table width="72%" height="77" border="0" align="center">
        <tr>
          <td align="center"><div style="font-family:宋体; color:#FFFFFF;  WIDTH: 100%; FONT-WEIGHT: bold; FONT-SIZE: 28px; margin-top:5pt"> 杉杉奥莱服装配饰订制与自主选购系统 </div></td>
        </tr>
      </table>
    </td>
  </tr>
                      ...
                      <form name="f11" id="f11" method="post" action="hsgloginyanzheng.jsp">
                        ...
                        <tr>
                          ...
                          <td height="30" colspan="2"><select name="cx" id="cx" style="height:18px; width:130px; border:solid 1px #cadcb2; font-size:12px; color:#81b432;">
                              ...
                              <option value="设计师信息">设计师</option>
                              <option value="客服信息">客服</option>
							  <option value="用户信息">用户</option>
                              <!--quxanxiaxndexnglxu-->
                            </select>							</td>
                          </tr>
                        <tr>
