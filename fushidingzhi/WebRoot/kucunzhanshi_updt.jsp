...
function gows()
{
	document.location.href="kucunzhanshi_add.jsp?id=<%=id%>";
}
function hsgxia2shxurxu(nstr,nwbk)
{
	...
	<body>
			<form action="updateKucunzhanshi.do" name="form1" method="post">
				      <table width="100%" border="1" align="center" cellpadding="3" cellspacing="1"  style="border-collapse:collapse" bgcolor="#F2FDFF">
						<tr bgcolor="#E7E7E7">
							<td height="20" colspan="2" background="images/table_header.gif">修改库存展示<input type="hidden" name="id" value="${kucunzhanshi.id}" /></td>
						</tr>
						...
						<script language="javascript">document.form1.shejibianhao.value='${kucunzhanshi.shejibianhao}';</script>	<script language="javascript">document.form1.shejimingcheng.value='${kucunzhanshi.shejimingcheng}';</script>	<script language="javascript">document.form1.mobanleixing.value='${kucunzhanshi.mobanleixing}';</script>	<script language="javascript">document.form1.jiage.value='${kucunzhanshi.jiage}';</script>	<script language="javascript">document.form1.kucunshuliang.value='${kucunzhanshi.kucunshuliang}';</script>	<script language="javascript">document.form1.rukuriqi.value='${kucunzhanshi.rukuriqi}';</script>	<script language="javascript">document.form1.xiugaishijian.value='${kucunzhanshi.xiugaishijian}';</script>	<script language="javascript">document.form1.xiugairen.value='${kucunzhanshi.xiugairen}';</script>	
					 </table>
			</form>
   </body>
</html>
