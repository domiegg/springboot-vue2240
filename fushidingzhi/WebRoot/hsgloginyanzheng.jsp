...
<html>
 ...
 if(cx.equals("用户信息")){sql="select * from yonghuxinxi where yonghuming='"+uid+"' and mima='"+pwd+"'";}
 if(cx.equals("用户")){sql="select * from yonghuxinxi where yonghuming='"+uid+"' and mima='"+pwd+"'";}
 if(cx.equals("设计师信息")){sql="select * from shejishixinxi where yonghuming='"+uid+"' and mima='"+pwd+"'";}
 if(cx.equals("客服信息")){sql="select * from kefuxinxi where kefubianhao='"+uid+"' and mima='"+pwd+"'";}
 //quxanxiaxndexnglxu
