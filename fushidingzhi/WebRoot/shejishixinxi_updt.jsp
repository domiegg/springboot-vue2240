...
function gows()
{
	document.location.href="shejishixinxi_add.jsp?id=<%=id%>";
}
	...
	<body>
			<form action="updateShejishixinxi.do" name="form1" method="post">
				      <table width="100%" border="1" align="center" cellpadding="3" cellspacing="1"  style="border-collapse:collapse" bgcolor="#F2FDFF">
						...
						<script language="javascript">document.form1.yonghuming.value='${shejishixinxi.yonghuming}';</script>	<script language="javascript">document.form1.mima.value='${shejishixinxi.mima}';</script>	<script language="javascript">document.form1.xingming.value='${shejishixinxi.xingming}';</script>	<script language="javascript">document.form1.xingbie.value='${shejishixinxi.xingbie}';</script>	<script language="javascript">document.form1.jibie.value='${shejishixinxi.jibie}';</script>	<script language="javascript">document.form1.shouji.value='${shejishixinxi.shouji}';</script>	<script language="javascript">document.form1.youxiang.value='${shejishixinxi.youxiang}';</script>	<script language="javascript">document.form1.dizhi.value='${shejishixinxi.dizhi}';</script>	<script language="javascript">document.form1.zhaopian.value='${shejishixinxi.zhaopian}';</script>	<script language="javascript">document.form1.beizhu.value='${shejishixinxi.beizhu}';</script>	
					 </table>
			</form>
   </body>
</html>
