...
-->
	...
	<body>
			<form action="updateKefuxinxi2.do" name="form1" method="post">
				      <table width="100%" border="1" align="center" cellpadding="3" cellspacing="1"  style="border-collapse:collapse" bgcolor="#F2FDFF">
						<tr bgcolor="#E7E7E7">
							<td height="20" colspan="2" background="images/table_header.gif">修改客服信息<input type="hidden" name="id" value="${kefuxinxi.id}" /></td>
						</tr>
						...
						<script language="javascript">document.form1.kefubianhao.value='${kefuxinxi.kefubianhao}';</script>	<script language="javascript">document.form1.mima.value='${kefuxinxi.mima}';</script>	<script language="javascript">document.form1.xingming.value='${kefuxinxi.xingming}';</script>	<script language="javascript">document.form1.xingbie.value='${kefuxinxi.xingbie}';</script>	<script language="javascript">document.form1.shouji.value='${kefuxinxi.shouji}';</script>	<script language="javascript">document.form1.youxiang.value='${kefuxinxi.youxiang}';</script>	<script language="javascript">document.form1.zhaopian.value='${kefuxinxi.zhaopian}';</script>	<script language="javascript">document.form1.beizhu.value='${kefuxinxi.beizhu}';</script>	
					 </table>
			</form>
   </body>
</html>
