	...
	<body>
			<form action="updateCaiwuguanli.do" name="form1" method="post">
				      <table width="100%" border="1" align="center" cellpadding="3" cellspacing="1"  style="border-collapse:collapse" bgcolor="#F2FDFF">
						<tr bgcolor="#E7E7E7">
							<td height="20" colspan="2" background="images/table_header.gif">修改财务管理<input type="hidden" name="id" value="${caiwuguanli.id}" /></td>
						</tr>
						...
						<script language="javascript">document.form1.caiwubianhao.value='${caiwuguanli.caiwubianhao}';</script>	<script language="javascript">document.form1.biaoti.value='${caiwuguanli.biaoti}';</script>	<script language="javascript">document.form1.yuefen.value='${caiwuguanli.yuefen}';</script>	<script language="javascript">document.form1.dingdanshuliang.value='${caiwuguanli.dingdanshuliang}';</script>	<script language="javascript">document.form1.dingdanzongjia.value='${caiwuguanli.dingdanzongjia}';</script>	<script language="javascript">document.form1.duizhangzhuangtai.value='${caiwuguanli.duizhangzhuangtai}';</script>	<script language="javascript">document.form1.beizhu.value='${caiwuguanli.beizhu}';</script>	<script language="javascript">document.form1.wenjian.value='${caiwuguanli.wenjian}';</script>	<script language="javascript">document.form1.jilushijian.value='${caiwuguanli.jilushijian}';</script>	<script language="javascript">document.form1.jiluru.value='${caiwuguanli.jiluru}';</script>	
					 </table>
			</form>
   </body>
</html>
