...
-->
	...
	<table width="100%" border="0" cellpadding="0" cellspacing="0">
			  ...
			  <table width="100%" border="0" align="center" cellpadding="4" cellspacing="1" bgcolor="#aec3de">
					...
					<tr align="right" bgcolor="#ebf0f7">
					  ...
					  <table width="100%" border="0" align="center" cellpadding="4" cellspacing="1" >
						<tr align="left" >
							<td colspan="17">
								<form action="kucunzhanshiList.do" name="myform" method="post">
		 ...
		 <%
			String sql="select * from kucunzhanshi where 1=1 ";
...
while(RS_result.next()){
		 ...
		 <c:if test="${page.page>1}">
              <a href="kucunzhanshiList.do?page=1" >首页</a>
             <a href="kucunzhanshiList.do?page=${page.page-1 }"> 上一页</a>             </c:if>
    	     <c:if test="${page.page<page.totalPage}">
			<a href="kucunzhanshiList.do?page=${page.page+1 }">下一页</a>
			<a href="kucunzhanshiList.do?page=${page.totalPage }">末页</a>		    </c:if>		
	</c:if>
	</p>
