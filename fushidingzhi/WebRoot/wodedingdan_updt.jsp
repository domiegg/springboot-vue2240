...
function hsgxia2shxurxu(nstr,nwbk)
{
	...
	<body>
			<form action="updateWodedingdan.do" name="form1" method="post">
				      <table width="100%" border="1" align="center" cellpadding="3" cellspacing="1"  style="border-collapse:collapse" bgcolor="#F2FDFF">
						<tr bgcolor="#E7E7E7">
							<td height="20" colspan="2" background="images/table_header.gif">修改我的订单<input type="hidden" name="id" value="${wodedingdan.id}" /></td>
						</tr>
						...
						<script language="javascript">document.form1.shejibianhao.value='${wodedingdan.shejibianhao}';</script>	<script language="javascript">document.form1.shejimingcheng.value='${wodedingdan.shejimingcheng}';</script>	<script language="javascript">document.form1.mobanleixing.value='${wodedingdan.mobanleixing}';</script>	<script language="javascript">document.form1.jiage.value='${wodedingdan.jiage}';</script>	<script language="javascript">document.form1.dingdanshuliang.value='${wodedingdan.dingdanshuliang}';</script>	<script language="javascript">document.form1.dingdanjiage.value='${wodedingdan.dingdanjiage}';</script>	<script language="javascript">document.form1.lianxidianhua.value='${wodedingdan.lianxidianhua}';</script>	<script language="javascript">document.form1.shouhuodizhi.value='${wodedingdan.shouhuodizhi}';</script>	<script language="javascript">document.form1.chuangjianshijian.value='${wodedingdan.chuangjianshijian}';</script>	<script language="javascript">document.form1.goumairen.value='${wodedingdan.goumairen}';</script>	
					 </table>
			</form>
   </body>
</html>
