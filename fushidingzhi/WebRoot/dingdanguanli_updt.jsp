...
function hsgxia2shxurxu(nstr,nwbk)
{
	...
	<body>
			<form action="updateDingdanguanli.do" name="form1" method="post">
				      <table width="100%" border="1" align="center" cellpadding="3" cellspacing="1"  style="border-collapse:collapse" bgcolor="#F2FDFF">
						<tr bgcolor="#E7E7E7">
							<td height="20" colspan="2" background="images/table_header.gif">修改订单管理<input type="hidden" name="id" value="${dingdanguanli.id}" /></td>
						</tr>
		...
		<tr ><td width="200">订单数量：</td><td><input name='dingdanshuliang' type='text' id='dingdanshuliang' value='' onblur='' style='border:solid 1px #000000; color:#666666'  readonly='readonly' /></td></tr>
		<tr ><td width="200">订单价格：</td><td><input name='dingdanjiage' type='text' id='dingdanjiage' value='' onblur='' style='border:solid 1px #000000; color:#666666'  readonly='readonly' /></td></tr>
		...
		<tr ><td width="200">购买人：</td><td><input name='goumairen' type='text' id='goumairen' value='' onblur='' style='border:solid 1px #000000; color:#666666'  readonly='readonly' /></td></tr>
		...
		<tr 3><td width="200">记录人：</td><td><input name='jiluren' type='text' id='jiluren' onblur='' style='border:solid 1px #000000; color:#666666' value='<%=(String)request.getSession().getAttribute("username")%>' readonly="readonly" /></td></tr>
						...
						<script language="javascript">document.form1.shejibianhao.value='${dingdanguanli.shejibianhao}';</script>
	<script language="javascript">document.form1.shejimingcheng.value='${dingdanguanli.shejimingcheng}';</script>
	<script language="javascript">document.form1.mobanleixing.value='${dingdanguanli.mobanleixing}';</script>
	<script language="javascript">document.form1.dingdanshuliang.value='${dingdanguanli.dingdanshuliang}';</script>
	<script language="javascript">document.form1.dingdanjiage.value='${dingdanguanli.dingdanjiage}';</script>
	<script language="javascript">document.form1.shouhuodizhi.value='${dingdanguanli.shouhuodizhi}';</script>
	<script language="javascript">document.form1.lianxidianhua.value='${dingdanguanli.lianxidianhua}';</script>
	<script language="javascript">document.form1.goumairen.value='${dingdanguanli.goumairen}';</script>
	<script language="javascript">document.form1.dingdanzhuangtai.value='${dingdanguanli.dingdanzhuangtai}';</script>
	<script language="javascript">document.form1.wuliuzhuangtai.value='${dingdanguanli.wuliuzhuangtai}';</script>
	<script language="javascript">document.form1.wuliudanhao.value='${dingdanguanli.wuliudanhao}';</script>
	<script language="javascript">document.form1.jilushijian.value='${dingdanguanli.jilushijian}';</script>
	<script language="javascript">document.form1.jiluren.value='${dingdanguanli.jiluren}';</script>
