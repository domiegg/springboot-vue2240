	...
	<body>
			<form action="updateYonghuxinxi2.do" name="form1" method="post">
				      <table width="100%" border="1" align="center" cellpadding="3" cellspacing="1"  style="border-collapse:collapse" bgcolor="#F2FDFF">
						...
						<script language="javascript">document.form1.yonghuming.value='${yonghuxinxi.yonghuming}';</script>	<script language="javascript">document.form1.mima.value='${yonghuxinxi.mima}';</script>	<script language="javascript">document.form1.xingming.value='${yonghuxinxi.xingming}';</script>	<script language="javascript">document.form1.xingbie.value='${yonghuxinxi.xingbie}';</script>	<script language="javascript">document.form1.shouji.value='${yonghuxinxi.shouji}';</script>	<script language="javascript">document.form1.youxiang.value='${yonghuxinxi.youxiang}';</script>	<script language="javascript">document.form1.diqu.value='${yonghuxinxi.diqu}';</script>	<script language="javascript">document.form1.youzhengbianhao.value='${yonghuxinxi.youzhengbianhao}';</script>	<script language="javascript">document.form1.dizhi.value='${yonghuxinxi.dizhi}';</script>	<script language="javascript">document.form1.zhaopian.value='${yonghuxinxi.zhaopian}';</script>	<script language="javascript">document.form1.beizhu.value='${yonghuxinxi.beizhu}';</script>	
					 </table>
			</form>
   </body>
</html>
