...
-->
			  ...
			  <table width="100%" border="0" align="center" cellpadding="4" cellspacing="1" bgcolor="#aec3de">
					...
					<tr align="right" bgcolor="#ebf0f7">
					  ...
					  <table width="100%" border="0" align="center" cellpadding="4" cellspacing="1" >
						<tr align="left" >
							<td colspan="17">
								<form action="wodedingdanList.do" name="myform" method="post">
    ...
    <td align='center'>${u.issh} <input type="button" value="审核" onClick="javascript:location.href='sh.jsp?id=${u.id}&yuan=${u.issh}&tablename=wodedingdan'"/></td>
                              ...
                              <td align="center"><a href="dingdanguanli_add.jsp?id=${u.id }">订单</a>  <a href="wodedingdanDetail.do?id=${u.id}">详细</a></td>
                            </tr>
                          </c:forEach>
                        </table></td>
						</tr>
		 ...
		 <%
			String sql="select * from wodedingdan where 1=1 ";
...
while(RS_result.next()){
		...
		共计订单价格:<%=dingdanjiagez%>； 
		 ...
		 <c:if test="${page.page>1}">
              <a href="wodedingdanList.do?page=1" >首页</a>
             <a href="wodedingdanList.do?page=${page.page-1 }"> 上一页</a>             </c:if>
    	     <c:if test="${page.page<page.totalPage}">
			<a href="wodedingdanList.do?page=${page.page+1 }">下一页</a>
			<a href="wodedingdanList.do?page=${page.totalPage }">末页</a>		    </c:if>		
	</c:if>
	</p>
