...
-->
	...
	<table width="100%" border="0" cellpadding="0" cellspacing="0">
				...
				<td>
					<table width="100%" border="0" align="center" cellpadding="4" cellspacing="1" bgcolor="#aec3de">
						<tr align="left" bgcolor="#F2FDFF">
							<td colspan="17" background="images/table_header.gif">库存展示列表</td>
						</tr>
					</table>
				</td>
			</tr>
			  ...
			  <table width="100%" border="0" align="center" cellpadding="4" cellspacing="1" bgcolor="#aec3de">
					...
					<tr align="right" bgcolor="#ebf0f7">
					  ...
					  <table width="100%" border="0" align="center" cellpadding="4" cellspacing="1" >
						<tr align="left" >
							<td colspan="17">
								<form action="kucunzhanshiList2.do" name="myform" method="post">
				...
				%>
                            <tr align="center" bgcolor="#FFFFFF">
                             ...
                             <td>${u.shejibianhao}</td>    <td>${u.shejimingcheng}</td>    <td>${u.mobanleixing}</td>    <td>${u.jiage}</td>    <td>${u.kucunshuliang}</td>    <td>${u.rukuriqi}</td>    <td>${u.xiugaishijian}</td>    <td>${u.xiugairen}</td>    
                              ...
                              <td align="center"><a href="doUpdateKucunzhanshi.do?id=${u.id }">编辑</a>  <a href="deleteKucunzhanshi.do?id=${u.id }"
										onclick="{if(confirm('确定要删除吗?')){return true;}return false;}">删除</a> <a href="kucunzhanshiDetail.do?id=${u.id }">详细</a></td>
                            </tr>
                          </c:forEach>
                        </table></td>
						</tr>
		 ...
		 <%
			String sql="select * from kucunzhanshi where xiugairen='"+(String)request.getSession().getAttribute("username")+"'  ";
...
while(RS_result.next()){
		 ...
		 <c:if test="${page.page>1}">
              <a href="kucunzhanshiList2.do?page=1" >首页</a>
             <a href="kucunzhanshiList2.do?page=${page.page-1 }"> 上一页</a>             </c:if>
    	     <c:if test="${page.page<page.totalPage}">
			<a href="kucunzhanshiList2.do?page=${page.page+1 }">下一页</a>
			<a href="kucunzhanshiList2.do?page=${page.totalPage }">末页</a>		    </c:if>		
	</c:if>
	</p>
